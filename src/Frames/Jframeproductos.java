...
public class Jframeproductos extends javax.swing.JFrame {
     ...
     */
    public Jframeproductos(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
    ...
    private void initComponents() {
        ...
        jScrollPa = new javax.swing.JScrollPane();
        ...
        jScrollPa.setViewportView(jTable1_productosAll22);

        getContentPane().add(jScrollPa, java.awt.BorderLayout.CENTER);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {               
                Jframeproductos Jframe = new Jframeproductos(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JScrollPane jScrollPa;
    public javax.swing.JTable jTable1_productosAll22;
